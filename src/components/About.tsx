...
export default function About() {
    ...
    <section id="about">
        ...
        <p> I'm a <strong>software engineer</strong> passionate about building reliable, well-crafted systems. Whether it's a backend service, a data pipeline, or a polished interface, I care about the details that make software feel solid.</p>
